...
--==>> بواسطة @aa77c <<==
-- للمزيد من المعلومات قناتنا @srore_HD
--]]
redis = require('redis') 
...
NAMEBOT = (tahadevstorm:get(DEVSTOR..'storm:name') or 'روكا')
...
os.execute('rm -rf ROKA.lua') 
os.execute("rm -fr plugins_/help_rep.lua")
os.execute('wget https://raw.githubusercontent.com/STORMBOT/ROKA/master/ROKA.lua') 
...
local text = [[
📮¦ اهلا بك في سورس روكا 🍃
ٴ━━━━━━━━━━
🗃¦ لتنصيب السورس ↓↑
ٴ━━━━━━━━━━
⚜¦ افتح ترمنال جديد 
⚜¦ انسخ رابط كيثاب السورس  ↡
`git clone https://github.com/STORMBOT/ROKA.git; cd ROKA;chmod +x tg;chmod +x ROKA.sh;chmod +x RK;./ROKA.sh`
ـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ
